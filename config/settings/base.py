...
DATABASES = {}
DATABASES['default'] = dj_database_url.config(default='postgresql://tigerpath:sQ1r8BZOjWYoRE9ldGyrgpMoU1WHWQWR7XD0Lfibri6jU9gDRqsnG7r2QKUIF9Hq5@167.99.236.185/tigerpath')
